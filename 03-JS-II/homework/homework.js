...
function saludo(idioma) {
  ...
  // Si "idioma" es "ingles", devuelve "ingles"
...
function operadoresLogicos(num1, num2, num3) {
  ...
  } else if ( num3 > num2 && num3 > num1) { // num3 > num1,num3
    return num3 += 1;
...
function esPrimo(numero) {
  ...
  divisible = []
for (i =1; i<=numero; i++) {
 if (Number.isInteger(numero/i)==false) {
  continue;
 } else {
  divisible.push(i)
 }
...
function tablaDelSeis(){
  ...
  let tablaDelSeisl = []
  for (i = 0; i <= 10; i++) {
    tablaDelSeisl.push(i*6)
  }
  return tablaDelSeisl;
